...
const commands = [
    ...
    '<br>Menu :   <br><br><span class="menu-option" onclick="navigateTo(\'About/About_me.html\')">About me</span> <br><br> <span class="menu-option" onclick="navigateweb(\'https://www.github.com/Kurama-90\')">Projects</span> <br><br> <span class="menu-option" onclick="navigateTo(\'About/About_me.html\')">Contact</span>',
